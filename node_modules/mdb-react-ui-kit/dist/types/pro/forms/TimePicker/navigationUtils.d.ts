...
declare const handleHoursKeys: (format: '12h' | '24h', activeHour: number, setActiveHour: Dispatch<SetStateAction<number>>, setHourAngle: Dispatch<SetStateAction<number>>, isUp: boolean) => void;
declare const handleTab: (setTabCount: Dispatch<SetStateAction<number>>, tabCount: number, target?: HTMLDivElement | null) => void;
declare const handleClickOutside: (e: MouseEvent<HTMLElement>, setIsPickerOpened: Dispatch<SetStateAction<boolean>>, inline: boolean, target: HTMLDivElement | null, inputTarget: HTMLInputElement | null) => void;
