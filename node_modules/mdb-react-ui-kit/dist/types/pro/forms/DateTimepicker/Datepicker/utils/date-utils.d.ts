...
export declare function isMonthDisabled(month: number, year: number, minDate?: Date, maxDate?: Date): boolean | number;
export declare function isYearDisabled(year: number, minDate?: Date, maxDate?: Date): boolean | number;
